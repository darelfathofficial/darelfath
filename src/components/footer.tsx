...
const Footer = ({ content }: FooterProps) => {
  return (
    <footer className="footer-area sub-bg">
      ...
      <div className="footer__shape-right sway_Y__animationY">
        <img src="/images/shape/footer-shape-right.png" alt="shape" />
      </div>
      <div className="container">
        <div className="footer__wrp pt-100 pb-100">
          ...
          <div className="footer__item item-sm wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
            <h3 className="footer-title">Jurusan</h3>
            <ul>
              {content.major.map((item, idx) => (
                <li key={idx}>
                  <a href={item.page}>
                    <i className="fa-regular fa-angles-right me-1"></i>
                    {item.title}
          ...
          <div className="footer__item footer-subscribe wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
            <h3 className="footer-title">Hubungi Kami</h3>
            <ul className="mt-25">
              <li>
                <svg className="inline me-1" width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <div className="container">
          <div className="d-flex gap-1 flex-wrap align-items-center justify-content-md-between justify-content-center">
            <p className="wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
              ...
              <a href="https://darelfath.netlify.app" className="primary-color">
                &nbsp;SMK - IT Darel Fath School
              </a>
            </p>
          </div>
        </div>
